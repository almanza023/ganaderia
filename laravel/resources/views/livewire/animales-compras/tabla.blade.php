  ...
  <div class="row m-t-30">
    <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="card m-b-30">
            <div class="card-body">
                <h4 class="mt-0 header-title"> CONSULTA DE COMPRAS</h4><br>
                <a href="{{ route('compras.crear') }}" class="btn btn-raised btn-primary m-t-10 m-b-10">
                    <i class="typcn typcn-document-add"> </i>CREAR COMPRAS</a>
                   <br><br>
