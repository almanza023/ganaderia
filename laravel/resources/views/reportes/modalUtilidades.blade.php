<div wire:ignore.self id="modalUtilidades" class="modal fade bd-example-modal-form" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" >
                <h5 class="modal-title" id="exampleModalform">DATOS DE REPORTE</h5>
            ...
            <div>
                <div class="modal-body">
                    <form action="{{ route('reporte-utilidades') }}" method="POST" target="_blanck">
                        @csrf
                    <div class="row">
                        <div class="col-md-6">
